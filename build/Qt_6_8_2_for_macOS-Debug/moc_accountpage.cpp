...
#include "../../../FitBuddyv3/FitBuddy/accountpage.h"
...
static constexpr auto qt_meta_stringdata_ZN11AccountPageE = QtMocHelpers::stringData(
    "AccountPage",
    "backToMain",
    "",
    "onBackButtonClicked"
...
Q_CONSTINIT static const uint qt_meta_data_ZN11AccountPageE[] = {
...
Q_CONSTINIT const QMetaObject AccountPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11AccountPageE.offsetsAndSizes,
    qt_meta_data_ZN11AccountPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11AccountPageE_t,
        // Q_OBJECT / Q_GADGET
...
void AccountPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (AccountPage::*)();
            if (_q_method_type _q_method = &AccountPage::backToMain; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *AccountPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11AccountPageE.stringdata0))
